...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-10 text-right font-tajawal">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm gap-4">
        <div>
          <h2 className="text-3xl font-black text-primary">لوحة القيادة العليا</h2>
          <p className="text-gray-400 mt-1 font-bold text-sm">نظرة شاملة ومباشرة على أداء المنصة.</p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <div className="bg-white rounded-[2.5rem] border border-gray-100 p-8 relative overflow-hidden group hover:border-primary/20 transition-all">
         ...
         <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-100 rounded-[2.5rem] p-8">
               ...
               <div className="space-y-3">
                  ...
                  <button className="w-full text-right px-6 py-4 rounded-2xl bg-gray-50 hover:bg-gray-100 text-sm font-bold transition-colors text-gray-700 flex justify-between items-center group">
                     <span>تحديث إعدادات العمولة</span>
                     <ArrowRight className="w-4 h-4 text-gray-300 group-hover:text-primary transition-colors" />
                  </button>
               </div>
            </div>
